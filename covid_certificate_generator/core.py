...
__all__ = ['df', 'PDF', 'generate_one_attestation', 'generate', 'pdf_w', 'pdf_h', 'pdf']
...
pdf.set_author('Data For Good France')
#pdf.set_doc_option('core_fonts_encoding', 'utf-8')

def generate_one_attestation(prenom_parent, nom_parent, prenom_enfant, nom_enfant, date_naissance, moyen):
    pdf.add_page()
    #pdf.lines()
    pdf.titles()
    pdf.texte_parent(prenom_parent, nom_parent)
    pdf.texte_enfant(prenom_enfant, nom_enfant,date_naissance, moyen)
    pdf.texte_etablissement('Ecole Jean Jaurès', 'rue Jean Jaurès, 42 000 Libreville', 'cachet.jpg','Libreville')
